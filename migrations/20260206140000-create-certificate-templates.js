...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // 2. Create certificate_template_formats table
    await queryInterface.createTable('certificate_template_formats', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('certificate_template_formats');
